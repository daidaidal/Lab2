...
<body>
    ...
    <p>please input the update information of the book here:</p>
    <form id="form2" name="form2" method="post" action="Update">
      <p>title:&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" name="booku.title" id="title" />
      </p>
      <p>authorid: &nbsp;&nbsp;&nbsp;
        <input type="text" name="booku.authorid" id="authorid" />
      </p>
      <p>publisher: &nbsp;&nbsp;
        <input type="text" name="booku.publisher" id="publisher" />
      </p>
      <p>publishdate:
        <input type="text" name="booku.publishdate" id="publishdate" />
       	 （format : 2000-1-1)
      </p>
      <p>price:&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp; 
        <input type="text" name="booku.price" id="price" />
      </p>
      <p>
        <input type="submit" value="update" /> ${checku}
      </p>
    </form>

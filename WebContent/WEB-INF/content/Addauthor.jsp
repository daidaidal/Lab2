...
<body>
    <h1>Add author</h1>
    <p>please input author information:</p>
    <form id="form1" name="form1" method="post" action="Addauthor">
      <p>name:&nbsp;&nbsp;&nbsp;
        <label for="name"></label>
        <input type="text" name="authoraddl.name" id="name" />
      </p>
      <p>authorid:
        <input type="text" name="authoraddl.authorid" id="authorid" />
      </p>
      <p>age:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" name="authoraddl.age" id="age" />
      </p>
      <p>country: 
        
        
        <input type="text" name="authoraddl.country" id="country" />
      </p>
      <p>
        <input type="submit"value="add" />  &nbsp ${m}
      </p>
    </form>
    <form id="form2" name="form2" method="post" action="Rtaddbook">
      &nbsp;
